...
class PostsController extends Controller
{
    ...
    {        
        // $logged_in_user_id = $request->query('logged_in_user_id');
    ...
    public function getImage($url) {                
        ...
        if (Storage::exists($url)) {
            ...
            $path = Storage::disk()->path('_imagesDB/defaultImg.png');                
            return response()->file($path); 
        }          
    }    
    ...
    {                   
        ...
        if ($image) {
            ...
            $path = Storage::putFile('_imagesDB', $image);        
            $imageUrl = Storage::url('_imagesDB', $path);                         
            $request->request->add(['image_url' => $path]);                        
        }

        return new PostsResource(Posts::create($request->except('image')));
    }
    ...
    public function destroy($id)
    {
        ...
        // DELETE IMAGE
        if ($post->image_url && Storage::exists($post->image_url)) {
